...
LABOUR_DEMAND_DIR = os.path.join(DATA_ROOT, "labour_demand")
LABOUR_DEMAND_HISTORY_FILE = os.path.join(LABOUR_DEMAND_DIR, "analysis_history.json")
LABOUR_DEMAND_RETRIEVAL_K = 5
